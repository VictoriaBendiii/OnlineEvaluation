...
<html>
                ...
                <nav style="z-index: 1000;">
                    ...
                    <div class="menu">
                        <ul>
                            ...
                            <li><a href="#myModal">Join A Class</a></li>
                            <li style="color: white; font-size: 20px; "><a href="profile.php"> Welcome &nbsp; 
    ...
    <div class="row">
                ...
                $result = mysqli_query($conn, $sql);
                    ...
                    if (mysqli_num_rows($result) > 0 or mysqli_num_rows($result) == 0) {
                      ...
                      <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary" name ="join">Join class</button>
                          </div>
                        </div>
                      </div>
                </div>
